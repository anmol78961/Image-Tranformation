...
T_b = [1 0 0; 0 1 0; 0 0 4] + [1 0 35; 0 1 0; 0 0 1];

% (c) Anisotropic scale + translation.
T_c = [5 0 0; 0 1 0; 0 0 4] + [1 0 48; 0 1 8; 0 0 1];

% (d) Rotation + translation.
b = 0.75+pi/4;
T_d = [cos(b) sin(b) 0; -sin(b) cos(b) 0; 0 0 1/2] + [1 0 1/4; 0 1 10.5; 0 0 1];

% (e) Isotropic scale + rotation + translation.
a = 0.95+pi/4;
T_e = [1/6 0 0; 0 1/6 0; 0 0 1] + [cos(a) -sin(a) 0; sin(a) cos(a) 0; 0 0 1] + [1 0 6; 0 1 30.25; 0 0 1];

% (f) Anisotropic scale + rotation + translation.
c = pi/2;
T_f = [-0.75 2.5 0; 0 -2.5 0; 0 0 4] + [cos(c) sin(c) 0; -sin(c) cos(c) 0; 0 0 1] + [-1 0 24; 0 -1 83.25; 0 0 1];

% (g) Fully affine.
d = pi/4;
T_g = [1.5 1 0; 2 2 0; 0 0 2] + [cos(d) sin(d) 0; -sin(d) cos(d) 0; 0 0 1] + [1 0 32; 0 1 32; 0 0 1];

% (h) Perspective.
e = pi/4 - 0.5;
T_h = [4 -4 0; 0 -0.2 0; 0.05 -0.41 4] + [cos(e) sin(e) 0; -sin(e) cos(e) 0; 0 0 1] + [-1 0 59; 0 -1 34; 0 0 1];
